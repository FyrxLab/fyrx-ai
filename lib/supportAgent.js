...
async function answerSupportQuestion(message, config, opts = {}) {
    ...
    if (!underHourlyCap(message.guild.id)) {
        logDecision('DISCARD', `guild hit the ${MAX_AI_CALLS_PER_HOUR} AI calls/hour cap`, message);
        return false;
    }
